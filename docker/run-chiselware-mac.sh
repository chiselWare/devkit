...
#   CHISELWARE_DEV_VERSION=0.7.1 ./run-chiselware-mac.sh   # use env var version
...
# Usage: CHISELWARE_DEV_VERSION=<x.y.z> ./run-chiselware-mac.sh [command...]
#        ./run-chiselware-mac.sh -v <x.y.z> [command...]
